...
The following is the initital data processing steps taken
...
First generating the PHATE embedding and slinghsot trajectories. Both of these calculations are time consuming, so the following will not be evaluated, but in place for the sake of transparency. Both of the resulting objects are saved in the "./data" directory and are loaded in the subsequent code block.
